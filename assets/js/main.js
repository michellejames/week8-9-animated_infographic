...
var earlyBirdOwl = new Waypoint({
	...
	TweenMax.from(".early-birds-section h3", 2, {rotation: "-90", transformOrigin: "10px"});
	TweenMax.from(".night-owls-section h3", 2, {rotation: "90", transformOrigin: "100px"});

	TweenMax.from(".list-item5", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item6", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item7", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item8", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item9", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item10", 2.5,{top:'-100px', opacity:'0'});
	TweenMax.from(".list-item11", 2.5,{top:'-100px', opacity:'0'});
	},
	offset: '75%'
});
...
TweenMax.to (".large-clock-hand1", 8, {rotation: 360, transformOrigin:"bottom left", repeat: -1, ease: Power2.easeInOut,});
...
TweenMax.to(".bubble", 2, {scale: 1.2, repeat: -1, yoyo: true} );
